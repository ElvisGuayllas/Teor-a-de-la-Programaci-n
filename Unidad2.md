...
🛡️ **5. Validación: Se incluye una estructura condicional (`Si/SiNo`) anidada en el caso de la división para prevenir la división por cero, garantizando la estabilidad del programa.**  
